...
namespace UnityEditor.Performance.ProfileAnalyzer
{
    ...
    internal class ProfileAnalysis
    {
        ...
        [NonSerialized]
        private int idleTimesInSelectThreadFrame;
        public int IdleTimesInSelectThreadFrame
        {
            get
            {
               return  idleTimesInSelectThreadFrame;
            }
            set
            {
                idleTimesInSelectThreadFrame = value;
            }
        }

        [NonSerialized]
        private float selectMarkerTimes = 0.0f;

        public float SelectMarkerTimes
        {
            get => selectMarkerTimes;
            set => selectMarkerTimes = value;
        }
        ...
        public ProfileAnalysis()
        {
            ...
            m_Markers.Clear();
            m_Threads.Clear();
            idleTimesInSelectThreadFrame = 0;
        }
        ...
        public void UpdateSummary(int frameIndex, float msFrame)
        {
            ...
            m_FrameSummary.frames.Add(new FrameTime(frameIndex, msFrame, 1,0.0f));
        }
